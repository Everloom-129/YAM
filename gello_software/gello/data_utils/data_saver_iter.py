...
class DataSaver:
    def __init__(self, save_dir="/home/sean/Desktop/YAM/gello_software/data", task_directory="Testing_dir"):
    ...
    def add_observation(self, obs):
        ...
        obs_copy['record_rgb'] = obs['record_camera_rgb']
        obs_copy['iteration'] = obs['iteration']
    ...
    def save_episode_json(self, buffer, pickle_only=False):
        ...
        iteration = buffer_dict['iteration']
